...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'Mohamed Oussema Boussida',
    title: 'Full-Stack Developer | DevOps Enthusiast | Problem Solver',
    skills: [
        'React', 'Angular', 'Node', 'Express', 'SpringBoot'
        'MySQL', 'MongoDB', 'Jenkins', 'Docker', 'TypeScript', 'Git'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack developer 🚀 | Crafting frameworks and coding the
                  future 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                {/* Contact Button */}
                <a
                  href="../../assets/CV_MOHAMED OUSSEMA_BOUSSIDA_ANG.pdf"
                  download
                  ...
                  <span className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 border border-gray-700/50 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-gray-800 group-hover:to-gray-700">
                    <span className="relative flex items-center justify-center gap-2 text-gray-300 font-medium group-hover:text-white">
                      ...
                      <i className="fas fa-envelope transform transition-all duration-300 group-hover:rotate-12"></i>
                                ...
                                <a
  href="https://www.linkedin.com/in/oussema-boussida/"
  target="_blank"
  rel="noopener noreferrer"
  className="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-teal-400 transition-all duration-300 hover:scale-110 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
>
